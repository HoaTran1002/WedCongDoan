...
import { Grid, Box, Container, Tooltip } from '@mui/material'
...
export default function Index(): JSX.Element {
  ...
  const listCompetition = rowComp
    ?.filter((r: any) => r.depId === depId)
            ...
            >
              {listDep?.map((row: any) => (
                <Box
                  ...
                  className={`BlogCompetition ${
                    depId == row.depId ? 'active' : ''
                  }`}
                >
                  {row.depName}
                </Box>
            ...
            >
              {listDep?.map((row: any) => (
                <Box
                  ...
                  component='li'
                  onClick={(): void => handleChangeDep(row.depId)}
                  className={`BlogCompetition_mobile ${
                    depId == row.depId ? 'active' : ''
                  }`}
                >
                  {row.depName}
            ...
            >
                          ...
                          >
                            <Box>
                              ...
                              <Tooltip title={row.comName} placement='top-end'>
                                <NameCompetition>{row.comName}</NameCompetition>
                              </Tooltip>
                            </Box>
                            <Box>
                              <TitleCompetition>
              ...
              >
                ...
                <Box
                  ...
                  onClick={handleNext}
                  disabled={
                    startIndex + dataPerPageListCompetition >= totalRows
                  }
                  className='button-pre-next'
                >
                  <KeyboardArrowRightIcon />
