...
const Index = (): JSX.Element => {
    ...
    // ==========================================
    const onchangePriName = function (event: React.ChangeEvent<HTMLInputElement>): void {
    ...
    const handleDeleteOK= (): void => {
        axios.delete(`/PrizeTypes?id=${prizeTId}`)
            .then((res) => {
            console.log(res.data);
            })
            .catch((error) => {
