                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Tooltip title="Xem đề thi" placement="top-start">
                          <Button style={{ width: 50 }}  href="/Competition" variant="outlined"><ArticleIcon /></Button>
                        </Tooltip>
                      </TableCell>
                      <TableCell align="right">
                        <Tooltip title="Xem chi tiết cuộc thi" placement="top-start">
                          <Button style={{ width: 50 }}  href="/Competition" variant="outlined"><RemoveRedEyeIcon /></Button>
                        </Tooltip>
                      </TableCell>
                    </TableRow>
                  ))}
